      ...
      <div>
        {EXPERIENCES.map ((Experience, index) => (
            <div key= {index} className="mb-8 flex flex-wrap lg:justify-center">
                ...
                {Experience.technologies.map((tech, index)=> (<span key={index} className="mr-2 mt-4 rounded bgn-neutral-900 px-2 py-1 text-sm font-medium text-blue-500">{tech}</span>)) }
                </motion.div>
            </div>
        ))} 
      </div>
