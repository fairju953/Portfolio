...
Manage complex claim workflows by coordinating with multiple stakeholders, negotiating resolutions, and maintaining accurate documentation and reporting.`,
    technologies: ["Microsoft Office Suite", "Claims Processing Software", "DMS"],
  },
  {
    year: "2020 - 2026",
    role: "Workers' Compensation Adjuster",
...
export const PROJECTS = [
  {
    ...
    technologies: ["Wazuh", "Sysmon", "Windows Event Logs", "Custom detection rules", "Ubuntu Server"],
  ...
  },
  {
    ...
    technologies: ["osTicket", "Raspberry Pi", "Apache", "PHP", "MariaDB", "Pi-hole", "Linux networking"],
  ...
  },
  {
    ...
    technologies: ["Windows Server 2022", "Active Directory", "Group Policy", "Windows 11", "VirtualBox"],
  ...
  },
  {
    ...
    technologies: ["Docker Compose", "Nextcloud", "MariaDB", "Redis", "Bash", "cron"],
